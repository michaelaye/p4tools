...
# %% auto #0
__all__ = ['plot_blotches_for_tile', 'plot_raw_fans', 'plot_raw_blotches', 'plot_fans_for_tile', 'plot_original_tile',
           'plot_original_and_fans', 'plot_original_and_blotches', 'plot_original_fans_blotches',
           'plot_x_random_tiles_with_n_fans', 'compute_direction_histogram', 'initialize_polar_axes', 'get_colorscale',
           'histogram_polar', 'histogram_cartesian', 'show_stamps']
