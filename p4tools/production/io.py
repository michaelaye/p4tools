...
# %% ../../notebooks/05a_production.io.ipynb #bdd47f9f
...
# %% ../../notebooks/05a_production.io.ipynb #77678bae
...
# %% ../../notebooks/05a_production.io.ipynb #22678c15
from configparser import ConfigParser
from pathlib import Path
import warnings
...
def get_config() -> ConfigParser:
    ...
    ------
    FileNotFoundError
        If the config file does not exist. Run ``set_database_path()`` to create it.
    """
...
if configpath.exists():
    ...
    data_root = None
    warnings.warn(
        f"No config file found at {configpath}. "
        f"Run p4tools.production.io.set_database_path('/path/to/data') to configure.",
        stacklevel=2,
    )

# %% ../../notebooks/05a_production.io.ipynb #8191cffa
...
# %% ../../notebooks/05a_production.io.ipynb #cd64d1fa
class PathManager:
...
# %% ../../notebooks/05a_production.io.ipynb #8bf71442
class DBManager:
