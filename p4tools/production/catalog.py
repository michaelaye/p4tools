...
# %% auto #0
__all__ = ['LOGGER', 'execute_in_parallel', 'marking_id_generator', 'fan_id_generator', 'blotch_id_generator', 'cluster_obsid',
           'fnotch_obsid', 'fnotch_obsid_parallel', 'cluster_obsid_parallel', 'get_L1A_paths', 'add_marking_ids',
...
def cluster_obsid(obsid=None, savedir=None, imgid=None, dbname=None):
    ...
    # Cluster with default save_results=True.
    # Filtering of sub-minimum clusters is handled inside
    # DBScanner.cluster_image_id after multi-stage concat.
